...
1. 选课：
   假期中选课答疑时间为2月15-17日， 
   下学期课表：http://cs.nuaa.edu.cn/2021/0116/c10851a228527/page.htm
   2021年1月20日将开通学生网上选课
 ---
 #### 2021/1计划
1. ML大作业（kaggle比赛）(1/15)【OK】；
2. 软件测试考试（1/7）【OK】;
3. 组会展示（1/15）；
4. 研究问题，提出自己的方法，实现。
    1. 一周两篇论文；
    2. 每周提出新想法，并实现（随便想~）；
5. 2021年3月14日前完成 2020年度组织生活会和民主评议党员工作.
 ---
###### 周工作安排（1/18-1/22）
1. 课题；
2. 选课；
...
- 今日工作：
1. 课题:
   观察其余数据集（clean1, iris, new-thyroid）效果；
   观察exp距离效果；
   分析熵增，然而H取1的概率基本不变的原因；
- 明日安排：
1. 统计熵增/减，label基本不变中排序为0~9的概率；
2. 看论文；
###### 周工作安排（1/11-1/16）
1. 学术规范与学术写作 作业（1/12）【OK】；
2. 提交机器学习大作业（PUBG比赛）(1/14)【OK】;
3. 课题；
###### 2021/1/14
- 今日工作：
  1. 从方法优势消失的轮数开始改为随机策略，看看后面一段的曲线是变好还是变差
###### 2021/1/13
- 今日工作：
  1. 你看能否统计一下每轮total score分布变化情况，是不是到后期H全是0了.
  x轴放大total_score尺度，10*total_score.
  2. 提交ML报告。
- 明日安排：
  1. 论文；
  2. 课题；
